...
60. <a href="#ST7789"></a>TRYGEAR-DASH-RP2350A と ST7789 で FizzBuzz [FizzBuzzST7789.ino](FizzBuzzST7789.ino)

I feel I’m knockin’ on heaven’s door (Knockin' on Heaven's Door 1973 Written by Bob Dylan)(1992 Cover by Guns N' Roses) 4月1日にスタンフォードB型急性大動脈解離を発症して天国の扉を叩いてきた。只今養生中。暇なので TRYGEAR-DASH-RP2350A と ST7789 で FizzBuzz。何故か Raspberry Pi Pico 2 互換ボードなのである。<br>

arduinoIDE を使ってプログラミングする。肝は「Raspberry Pi Pico/RP2040/RP2350 Boards」（Earle Philhower版）をインストールして「Raspberry Pi RP2040/RP2350 Boards」の中から、「Raspberry Pi Pico 2」を選択。「ライブラリマネージャ」で「Adafruit ST7735 and ST7789 Library」をインストールして、<br>
// TRYGEAR-DASH-RP2350A のTFTコネクタピン定義<br>
#define TFT_DC    16  // Data/Command 制御ピン<br>
#define TFT_CS    17  // Chip Select ピン<br>
#define TFT_RST   -1  // リセットピン（使用しない場合は-1、ボードのRESETと連動）<br>

他はいつも通りですね。<br>

[TRYGEAR-DASH-RP2350A の詳細はここを参照のこと](https://www.microfan.jp/2026/01/trygear-dash-rp2350a-r1/)<br>
[ST7789 の詳細はここを参照のこと](https://www.microfan.jp/2025/01/st7789-tft-display/)<br>
[Knockin' On Heaven's Door(Guns N' Roses)](https://www.youtube.com/watch?v=f8OHybVhQwc)<br>
